...
cd ..\HC_csv
 dirs = dir(fullfile('.','*.xlsx'));
    ...
    for file = files0'
        ...
        stimN100=erp2(stimulusTonefile,70,130,'min')-stimP50;
        stimP200=erp2(stimulusTonefile,180,235,'max')-stimP50;
        stimN200=erp2(stimulusTonefile,205,315,'min')-stimP50;
        stimP3a= erp2(stimulusTonefile,325,500,'max')-stimP50;
        stimP3b= erp2(stimulusTonefile,325,580,'max')-stimP50;
        stimSlow=erp2(stimulusTonefile,460,680,'min')-stimP50;
    ...
    for file = files1'
        ...
        targN100=erp2(targetTonefile,70,130,'min')-targP50;
        targP200=erp2(targetTonefile,180,235,'max')-targP50;
        targN200=erp2(targetTonefile,205,315,'min')-targP50;
        targP3a= erp2(targetTonefile,325,500,'max')-targP50;
        targP3b= erp2(targetTonefile,325,580,'max')-targP50;
        targSlow=erp2(targetTonefile,460,680,'min')-targP50;
    ...
    for file = files2'
        ...
        distN100=erp2(distractorTonefile,70,130,'min')-distP50;
        distP200=erp2(distractorTonefile,180,235,'max')-distP50;
        distN200=erp2(distractorTonefile,205,315,'min')-distP50;
        distP3a= erp2(distractorTonefile,325,500,'max')-distP50;
        distP3b= erp2(distractorTonefile,325,580,'max')-distP50;
        distSlow=erp2(distractorTonefile,460,680,'min')-distP50;
