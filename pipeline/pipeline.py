...
if not startAtFS:
    ...
    if not RECURR:
        ...
        # elif featureName == 'Wavelet':
            ...
            print(featureName)
            print("Invalid feature name. asf Choose from list in help documentation")
            sys.exit()
    ...
    if not os.path.exists(features_path):
        ...
        if (data_type == 'AR'):
            ...
            data_folder_path3 = None
            num_electrodes = 21
        print(data_folder_path1, "-", data_folder_path2)
        num_electrodes = 21
        ...
        or featureName == 'DomFreqVar' or featureName == 'TsFresh' or featureName == 'Steepness', featureName == 'PAC'):
...
for clf in clfs:
    feat_importances_et = get_feature_importance(
        clf, X, y, 50)  # top 50 features
    # print clf
