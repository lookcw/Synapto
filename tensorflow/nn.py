...
n_hidden3 = 20 # 2nd layer number of neurons
...
W4 = tf.Variable(tf.random_normal([n_hidden3, n_classes]), name="Weight3")
...
b4 = tf.Variable(tf.random_normal([n_classes]), name="Bias3")
